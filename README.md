...
<ol type="1">
  <li>Do long-term changes in temperature and/or DO correlate with changes in body size, population abundance, total community abundance, and/or community diversity? </li>
  <li>Are changes across different levels of ecological complexity (individual, population, community) correlated? </li>
