...
# NEON - CUPE - Fish electrofishing, gill netting, and fyke netting counts (https://doi.org/10.48443/ap3d-rp07)
# SCALES/ SSECR                  
# Sierra Perez   
...
data %>% 
  filter(is.na(fishTotalLength)) %>% dplyr::count() # 1 NA's
...
# most species have low abundances (mean = 10.64) and not crazy skew (max = 110.00)
...
# 35 observations not ID'd to species 
