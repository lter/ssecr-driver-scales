...
# NEON - HOPB - Fish electrofishing, gill netting, and fyke netting counts (https://doi.org/10.48443/ap3d-rp07)
# SCALES/ SSECR                  
# Sierra Perez   
...
unique(substr(data$date, 6, 7)) # months sampled: "10" "05" "11" "04"
...
# most species have low abundances (mean = 36.17), but somewhat right skewed (max = 312.00)
...
# 2 observations not ID'd to species 
...
# pops look like they crashed in 2021 -- why?

plot.presence(intermediate, 
              species_col = "SCI_NAME",
              subsite = F)
# 4 taxa only appear in 1 year
