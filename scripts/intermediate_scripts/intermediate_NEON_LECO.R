...
# NEON - LECO - Fish electrofishing, gill netting, and fyke netting counts (https://doi.org/10.48443/ap3d-rp07)
# SCALES/ SSECR                  
# Sierra Perez   
...
unique(substr(data$date, 6, 7)) # months sampled: "10" "11" "06" "04" "05"
