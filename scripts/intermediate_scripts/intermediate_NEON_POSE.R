...
# NEON - POSE - Fish electrofishing, gill netting, and fyke netting counts (https://doi.org/10.48443/ap3d-rp07)
# SCALES/ SSECR                  
# Sierra Perez   
...
data$taxonRank[data$taxonID == "COTBAI1"] <- "species"
