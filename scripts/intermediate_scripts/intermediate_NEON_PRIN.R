...
# NEON - PRIN - Fish electrofishing, gill netting, and fyke netting counts (https://doi.org/10.48443/ap3d-rp07)
# SCALES/ SSECR                  
# Sierra Perez   
...
data %>% 
  filter(fishTotalLength == 0) %>% dplyr::count() # 3 zeros
...
data$taxonRank[data$taxonID == "FUNNOT"] <- "species"
...
# 351 observations not ID'd to species 
